@echo off
title Activate Microsoft Office 2021 (ALL versions)
cls
echo =====================================================================================
...
cscript //nologo ospp.vbs /act | find /i "successful" && (
    echo.
    echo =====================================================================================
    echo Product activation successfull.
    echo =====================================================================================
    
	REM Show message box notifying user of successful activation
	mshta "javascript:var sh=new ActiveXObject('WScript.Shell');sh.Popup('Microsoft Office 2021 activated successfully! :)', 0, 'Activation Status', 64);close();"
